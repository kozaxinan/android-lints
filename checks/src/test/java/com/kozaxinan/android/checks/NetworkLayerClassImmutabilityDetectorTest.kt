...
internal class NetworkLayerClassImmutabilityDetectorTest {
  ...
  fun `kotlin file with var`() {
    lint()
        ...
        .expect(
            """
            src/foo/Api.kt:8: Error: Return type is not immutable. [totalNewResults] need to be final or val. [NetworkLayerImmutableDTORule]
              fun get(): Dto
                  ~~~
            1 errors, 0 warnings
            """.trimIndent()
    ...
    lint()
        ...
        .expect(
            ...
            src/foo/Api.kt:8: Error: Return type is not immutable. [totalNewResults] need to be final or val. [NetworkLayerImmutableDTORule]
              fun get(): Dto
                  ~~~
            src/foo/Api2.kt:8: Error: Return type is not immutable. [totalNewResults] need to be final or val. [NetworkLayerImmutableDTORule]
              fun get2(): Dto
                  ~~~~
            2 errors, 0 warnings
            """.trimIndent()
  ...
  fun `kotlin file inner dto with var`() {
    lint()
        ...
        .expect(
            """
            src/foo/Api.kt:8: Error: Return type is not immutable. [innerDto, innerResults] need to be final or val. [NetworkLayerImmutableDTORule]
              fun get(): Dto
                  ~~~
            1 errors, 0 warnings
            """.trimIndent()
  ...
  fun `kotlin file return type generic with var`() {
    lint()
        ...
        .expect(
            """
            src/foo/Api.kt:9: Error: Return type is not immutable. [totalNewResults] need to be final or val. [NetworkLayerImmutableDTORule]
              fun get(): Call<List<Dto>>
                  ~~~
            1 errors, 0 warnings
            """.trimIndent()
  ...
  fun `java file without final`() {
    lint()
        ...
        .expect(
            """
            src/foo/Api.java:8: Error: Return type is not immutable. [totalNewResults] need to be final or val. [NetworkLayerImmutableDTORule]
              Dto get();
                  ~~~
            src/foo/Api.java:11: Error: Return type is not immutable. [totalNewResults] need to be final or val. [NetworkLayerImmutableDTORule]
              Dto get2();
                  ~~~~
            2 errors, 0 warnings
            """.trimIndent()
